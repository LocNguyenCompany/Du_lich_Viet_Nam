                  ...
                  <div class="card-body">
                    <div class="table-responsive">
                      <table class="display" id="example-style-1">
                        ...
                        <tbody>
                          @foreach($diadanh as $value)
                          <tr>
                            <td>{{$value->id}}</td>
                            <td>{{$value->Ten_dia_danh}}</td>
                            <td>{{$value->Location}}</td>
                            <td>{{$value->Nha_nghi}}</td>
                            <td>{{$value->Danh_gia}}</td>
                            <td>{{$value->Khi_hau}}</td>
                            <td>{{$value->Tai_nguyen_thien_nhien}}</td>
                            <td>{{$value->Canh_vat}}</td>
                            <td> <a href="{{route('baiviet',['id'=>$value->id])}}"class="btn btn-primary" type="button">See post</a></td>
                            </tr>
                          @endforeach
                        </tbody>
                      </table>
